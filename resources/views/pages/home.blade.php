...
@section('content')
    {{-- الصق هنا slider section + section-padding من index.html --}}
						...
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<!-- <img src="images/slider/slider1.jpg" alt="" class="img-fluid"> -->
								 <img src="{{ asset('images/slider/slider1.jpg') }}"  alt="" class="img-fluid">
							</a>
						</div>
						...
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<!-- <img src="images/slider/slider2.jpg" alt="" class="img-fluid"> -->
								 <img src="{{ asset('images/slider/slider2.jpg') }}" alt="" class="img-fluid">
							</a>
						</div>
						<div class="slider-post-content">
						...
						<div class="post-thumb mb-4">
							<a href="#">
								<!-- <img src="images/slider/slider3.jpg" alt="" class="img-fluid"> -->
								 <img src="{{ asset('images/slider/slider3.jpg') }}"  alt="" class="img-fluid">
							</a>
						</div>
						<div class="slider-post-content">
...
<section class="section-padding">
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="blog-single.html">
                ...
                <img src="{{ asset('images/news/f1.jpg') }}" alt="" class="img-fluid w-100">
			</a>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="#">
				<img src="{{ asset('images/news/f3.jpg') }}" alt="" class="img-fluid w-100">
			</a>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="#">
				<img src="{{ asset('images/news/f4.jpg') }}" alt="" class="img-fluid w-100">
			</a>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="#">
				<img src="{{ asset('images/news/f5.jpg') }}" alt="" class="img-fluid w-100">
			</a>
			<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="#">
				<img src="{{ asset('images/news/f6.jpg') }}" alt="" class="img-fluid w-100">
			</a>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="#">
				<img src="{{ asset('images/news/f7.jpg') }}" alt="" class="img-fluid w-100">
			</a>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="#">
				<img src="{{ asset('images/news/f8.jpg') }}" alt="" class="img-fluid w-100">
			</a>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="#">
				<img src="{{ asset('images/news/f9.jpg') }}" alt="" class="img-fluid w-100">
			</a>
			<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="#">
				<img src="{{ asset('images/news/f10.jpg') }}" alt="" class="img-fluid w-100">
			</a>
			<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Experience</span>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="#">
				<img src="{{ asset('images/news/f11.jpg') }}" alt="" class="img-fluid w-100">
			</a>
			<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
	...
	<div class="col-lg-3 col-md-6">
		<article class="post-grid mb-5">
			<a class="post-thumb mb-4 d-block" href="#">
				<img src="{{ asset('images/news/f12.jpg') }}" alt="" class="img-fluid w-100">
			</a>
			<span class=" cat-name text-color font-sm font-extra text-uppercase letter-spacing">Lifestyle</span>
